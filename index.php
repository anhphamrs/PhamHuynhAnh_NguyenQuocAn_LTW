    ...
    <section class="flex content">
        <div id="container" class="flex content-wraper">
            <div class="flex filter">
                ...
                <div class="flex range-filter-wraper">
                    <div class="range-filter">0</div>
                    <div class="range-filter">15.000.000</div>
                </div>
                <input type="range" min="-10" max="10" />
                <div class="line"></div>
                <div>
                    <div id="filter-dropdown" class="active flex"><p class="title">Thương hiệu</p>
                        <div class="icon-dropdown"><i class="fa fa-angle-down" aria-hidden="true"></i></div>
                    </div>
                    <ul id="filter-dropdown-menu">
                        <div class="flex filter-dropdown-menu"><input type="checkbox"/><p>APOLLO</p></div>
                        <div class="flex filter-dropdown-menu"><input type="checkbox"/><p>Khác</p></div>
                        <div class="flex filter-dropdown-menu"><input type="checkbox"/><p>RAPOO</p></div>
                        <div class="flex filter-dropdown-menu"><input type="checkbox"/><p>SAMSUNG</p></div>
                    </ul>
                </div>
            </div>
            <div id="product">
